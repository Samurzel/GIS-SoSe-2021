namespace Aufgabe_2_2_3 {
    ...
    let r1: Rectangle = { x1: 10, y1: 10, x2: 20, y2: 20, strokecolor: "red" };
    console.log(r1);
...
//c)
    ...
    function createRect(): Rectangle {
        let w: number = getRandom(50, 600);
        let h: number = getRandom(50, 600);
        let x: number = getRandom(0, 150);
        let y: number = getRandom(0, 150);
        return {
            x1: w, //width
            y1: h, //height
            x2: x,
